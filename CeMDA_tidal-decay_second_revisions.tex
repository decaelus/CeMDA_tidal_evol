...
%DIF DEL CeMDA_tidal-decay_first_resubmission.tex    Thu May 12 15:58:50 2016
%DIF ADD CeMDA_tidal-decay_second-resubmission.tex   Thu May 12 16:06:44 2016
...
\title{Tidal Decay and \DIFdelbegin \DIFdel{Disruption }\DIFdelend \DIFaddbegin \DIFadd{Stable Roche-Lobe Overflow }\DIFaddend of Short-Period Gaseous Exoplanets
%\thanks{}
}
...
\DIFdelbegin %DIFDELCMD < \titlerunning{Tidal Decay and Disruption of Gaseous Exoplanets}        %%%
\DIFdelend \DIFaddbegin \titlerunning{Tidal Decay and Overflow of Gaseous Exoplanets}        \DIFaddend % if too long for running head
...
\begin{abstract}
Many gaseous exoplanets in short-period orbits are on the verge or are in the process of \DIFdelbegin \DIFdel{tidal disruption}\DIFdelend \DIFaddbegin \DIFadd{Roche-lobe overflow (RLO)}\DIFaddend . Moreover, orbital stability analysis shows tides can drive many hot Jupiters to spiral inevitably toward their host stars. Thus, the coupled processes of orbital evolution and \DIFdelbegin \DIFdel{tidal disruption }\DIFdelend \DIFaddbegin \DIFadd{RLO }\DIFaddend likely shape the observed distribution of close-in exoplanets and may even be responsible for producing some of the short-period rocky planets. However, the exact outcome for \DIFdelbegin \DIFdel{a disrupting }\DIFdelend \DIFaddbegin \DIFadd{an overflowing }\DIFaddend planet depends on its internal response to mass loss, and the accompanying orbital evolution can act to enhance or inhibit \DIFdelbegin \DIFdel{the disruption process}\DIFdelend \DIFaddbegin \DIFadd{RLO}\DIFaddend . In this study, we apply the fully-featured and robust Modules for Experiments in Stellar Astrophysics (MESA) suite to model \DIFdelbegin \DIFdel{Roche-lobe overflow (RLO ) }\DIFdelend \DIFaddbegin \DIFadd{RLO }\DIFaddend of short-period gaseous planets. We show that, although the detailed evolution may depend on several properties of the planetary system, it is largely determined by the core mass of the \DIFdelbegin \DIFdel{disrupting }\DIFdelend \DIFaddbegin \DIFadd{overflowing }\DIFaddend gas giant. In particular, we find that the orbital expansion that accompanies RLO often stops and reverses at a specific maximum period that depends on the core mass. We suggest that RLO may often strand the remnant of a \DIFdelbegin \DIFdel{disrupted }\DIFdelend gas giant near this orbital period, which provides an observational prediction that can corroborate the hypothesis that short-period gas giants undergo RLO. We conduct a preliminary comparison of this prediction to the observed population of small, short-period planets and find some planets in orbits that may be consistent with this picture. To the extent that we can establish some short-period planets are indeed the remnants of \DIFdelbegin \DIFdel{disrupted }\DIFdelend gas giants, that population can elucidate the properties of gas giant cores, the properties of which remain largely unconstrained.
...
The distribution of orbits for hot Jupiters extends to very near the planets' Roche limits, indicating that at least some hot Jupiters are on the verge of \DIFdelbegin \DIFdel{tidal disruption}\DIFdelend \DIFaddbegin \DIFadd{RLO}\DIFaddend . Others may actually be in the process of \DIFdelbegin \DIFdel{disruption}\DIFdelend \DIFaddbegin \DIFadd{RLO}\DIFaddend . For example, \cite{2010Natur.463.1054L} pointed out that WASP-12 b, a hot Jupiter in a 19-hour orbit, may be undergoing \DIFdelbegin \DIFdel{disruption }\DIFdelend \DIFaddbegin \DIFadd{RLO }\DIFaddend since its hot atmosphere likely extends up to planet's Roche lobe, even though the photosphere does not. 
...
The upshot of these simulations is that a planet's core mass can play a dominant role in setting the orbital evolution of \DIFdelbegin \DIFdel{a disrupting }\DIFdelend \DIFaddbegin \DIFadd{an overflowing }\DIFaddend planet. As long as mass transfer occurs quickly enough that stellar evolution is not a factor, we expect that a planetary mass-radius relationship that incorporates the dependence on core mass should allow us to predict at least the period at which orbital expansion of \DIFdelbegin \DIFdel{a disrupting }\DIFdelend \DIFaddbegin \DIFadd{an overflowing }\DIFaddend planet halts. If tidal decay ceased at that point, such a mass-radius relation would indicate exactly where we could find the remnant of a \DIFdelbegin \DIFdel{disrupted }\DIFdelend gaseous planet, given the remnant's mass (and density).

Unfortunately, comparing Figures \ref{fig:plot_mass_orbital_evolution_variable-Mp0-Mcore} and \ref{fig:plot_mass_orbital_evolution_variable-Mp0-Mcore_qs6}, it seems that, for conservative mass transfer, transfer rates large enough to nearly completely remove an atmosphere require tidal decay rates that produce rapid orbital decay of the remnant, destroying the evidence (the ``Complete \DIFdelbegin \DIFdel{Disruption }\DIFdelend \DIFaddbegin \DIFadd{RLO }\DIFaddend and Accretion'' scenario above). 
...
\section{Evolution of the Roche Limit for \DIFdelbegin \DIFdel{a Disrupting }\DIFdelend \DIFaddbegin \DIFadd{an Overflowing }\DIFaddend Gaseous Planet}
...
Our modeling suggests four distinct scenarios for \DIFdelbegin \DIFdel{disrupting }\DIFdelend \DIFaddbegin \DIFadd{overflowing }\DIFaddend gas giants (Section \ref{sec:dynamics_of_planetary_rochelobe_overflow}): (1) Little to No Tidal Decay, for which the currently observed properties of short-period planets essentially reflects their initial conditions; (2) Complete Accretion of the Planet, for which \DIFdelbegin \DIFdel{tidal disruption and }\DIFdelend \DIFaddbegin \DIFadd{RLO and tidal }\DIFaddend decay would very quickly remove short-period planets, masking much of the observational evidence for the process; (3) Incomplete \DIFdelbegin \DIFdel{Disruption }\DIFdelend \DIFaddbegin \DIFadd{RLO }\DIFaddend of the Planet's Atmosphere, in which case \DIFdelbegin \DIFdel{tidal disruption }\DIFdelend \DIFaddbegin \DIFadd{RLO }\DIFaddend proceeds relatively slowly and would leave behind gas-rich planets at their current Roche limits, a population not obvious among the observed planets (Figure \ref{fig:P-PRoche}); and (4) Complete \DIFdelbegin \DIFdel{Disruption }\DIFdelend \DIFaddbegin \DIFadd{RLO }\DIFaddend of the Atmosphere Alone, for which mass transfer removes the atmosphere of a hot Jupiter but leaves behind a denuded or gas-rich remnant near or interior to the maximum Roche limit attained during RLO, a population which is hinted at among the observed population (Figure \ref{fig:P_vs_PRoche-max}). 
...
We thank the editors for the invitation to contribute to this issue and their patience as we prepared this study. We also thank an anonymous referee \DIFaddbegin \DIFadd{and Prof.\ Ferraz-Mello }\DIFaddend for thoughtful input.
